              ...
              <div className="flex p-1.5 bg-gray-100/80 rounded-2xl mb-8 relative">
                ...
                <div className="flex gap-2 mb-6 bg-gray-100 p-1 rounded-xl">
                  <button
                    ...
                    className={`flex-1 py-2.5 rounded-lg font-bold text-sm transition-all ${loginMethod === 'phone'
                  ...
                  <button
                    ...
                    className={`flex-1 py-2.5 rounded-lg font-bold text-sm transition-all ${loginMethod === 'email'
                      ? 'bg-white text-gray-900 shadow-sm'
                      : 'text-gray-600'
                      }`}
                  >
